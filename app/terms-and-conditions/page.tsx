  ...
  return (
    <section className="termsContainer maxWidth flex flexColumn alignStart width90">
      ...
      <p>
        ...
        and harshitclub may further restrict access by you to any areas of this
      ...
      <p>
        ...
        rights. harshitclub reserves the right to remove any of Your Content
      ...
      <p>
        You hereby indemnify to the fullest extent harshitclub from and against
      ...
      <p>
        These Terms constitute the entire agreement between harshitclub and you
